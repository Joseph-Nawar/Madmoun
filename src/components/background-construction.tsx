...
export function BackgroundConstruction() {
  ...
  const logoOpacity = useTransform(scrollYProgress, [0.7, 1], [0.2, 1]);
  const logoScale = useTransform(scrollYProgress, [0.7, 1], [0.95, 1.05]);
    ...
    >
      ...
      >
        <Image
          src={logo}
          alt="Madmoun logo"
          className="logo-glow h-[22vh] w-auto opacity-80"
        />
      </motion.div>
